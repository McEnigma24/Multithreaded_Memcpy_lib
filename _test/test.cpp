...
TEST(Memcpy_no_cache, my_memcpy_1)
{
    const int size = 5000;
    const int size_bytes = sizeof(int) * size;
    ...
    Multithreaded_Memcpy::cpy_no_cache_polution((char*)tab_dest, (char*)tab_src, size_bytes, 1);

    EXPECT_EQ(memcmp(tab_src, tab_dest, size_bytes), 0);
}

TEST(Memcpy_no_cache, my_memcpy_2)
{
    const int size = 5000;
    const int size_bytes = sizeof(int) * size;
    ...
    Multithreaded_Memcpy::cpy_no_cache_polution((char*)tab_dest, (char*)tab_src, size_bytes, 2);

    EXPECT_EQ(memcmp(tab_src, tab_dest, size_bytes), 0);
}

TEST(Memcpy_no_cache, my_memcpy_2_5001)
{
    const int size = 5001;
    const int size_bytes = sizeof(int) * size;
...
TEST(Memcpy_no_cache, my_memcpy_3)
{
    const int size = 5000;
    const int size_bytes = sizeof(int) * size;
    ...
    Multithreaded_Memcpy::cpy_no_cache_polution((char*)tab_dest, (char*)tab_src, size_bytes, 3);

    EXPECT_EQ(memcmp(tab_src, tab_dest, size_bytes), 0);
}

TEST(Memcpy_no_cache, my_memcpy_7)
{
    const int size = 5001;
    const int size_bytes = sizeof(int) * size;
    ...
    Multithreaded_Memcpy::cpy_no_cache_polution((char*)tab_dest, (char*)tab_src, size_bytes, 7);

    EXPECT_EQ(memcmp(tab_src, tab_dest, size_bytes), 0);
}

TEST(Memcpy_no_cache, my_memcpy_7_1)
{
    const int size = 5000;
    const int size_bytes = sizeof(int) * size;
